            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="<?php if (isset($login_active)) echo "active" ?>">
                    ...
                    <li>
                        ...
                        <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0)"> <span class="glyphicon glyphicon-user"></span> <?php echo $_SESSION["admin"]->get_Name(); ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu nav nav-pills nav-stacked" style="margin-top: 5px; padding: 5px">
                            <?php $active = "list-group-item-info"; ?>
                            <li><a><strong class="text-info"> <?php echo $_SESSION["admin"]->get_User(); ?> </strong></a></li>
                            <li class="divider"></li>
                            <li><a href="/myadmin/" class="text-info"><div class="text-info"><span class="glyphicon glyphicon-info-sign"></span> Thông tin </div></a></li>
                    ...
                    ?>
                    <li><a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0)"> <span class="glyphicon glyphicon-user"></span> <?php echo $_SESSION["user"]->get_Name() ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu nav nav-pills nav-stacked" style="margin-top: 5px; padding: 5px">
                            <?php $active = "list-group-item-info"; ?>
                            <li><a><strong class="text-info"> <?php echo $_SESSION["user"]->get_User() ?> </strong></a></li>
                            <li class="divider"></li>
