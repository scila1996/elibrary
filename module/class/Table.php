...
abstract class Table {
    ...
    public function __construct($data) {
        ...
        $this->params = array_key_exists('params', $data) ? $data->params : array();
    ...
    public function Show() { // Return String's HTML
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <?php
                try {
                    if (!$num = Sql::select_WithCallBack($this->query, $this->params, function($value) use (&$i) {
                                ++$i;
                                $this->tr_td($i, $value);
                                return TRUE;
                    ...
                    ?>
                    <tr class="danger">
                        <td colspan="100"><span class="text-danger"><strong> <?php print $e->getMessage() ?> </strong></span></td>
                    </tr>
                    <?php
                }
                ?>
