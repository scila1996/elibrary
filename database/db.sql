...
--
-- Host: localhost
-- Generation Time: Jun 29, 2016 at 07:09 PM
...
CREATE TABLE `admins` (
  `name` char(50) NOT NULL DEFAULT 'Quản trị viên' COMMENT 'Tên người quản trị',
  `user` char(30) NOT NULL COMMENT 'Tài khoản người quản trị',
...
('Nguyễn Trung', 'root', '9c7a31a8336cabd3298dbfef065214245e4a4176', '2016-06-30 00:09:15');
